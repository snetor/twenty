...
export class CountryCodeCreateManyPreQueryHook implements WorkspacePreQueryHookInstance {
  constructor(
  ...
  async execute(
    ...
    objectName: string,
    payload: CreateManyResolverArgs<CountryCodeRecord>,
  ): Promise<CreateManyResolverArgs<CountryCodeRecord>> {
    ...
    return {
      ...payload,
      data: await this.countryCodeFromRelationService.injectCountryCode({

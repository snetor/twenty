...
export class TimelineCalendarEventService {
  ...
  async getCalendarEventsFromPersonIds({
    ...
    // Snetor — cloisonnement par pays. Ce chemin s'exécute en contexte système, et l'amont
    // y lit même le dépôt en `shouldBypassPermissionChecks: true` (voir plus bas) : le
